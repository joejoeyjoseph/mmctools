...
ts_header = [
    ...
    'glw',    # downward longwave radiation flux at the ground (downward is positive) [W/m^2]
    'gsw',    # net shortwave radiation flux at the ground (downward is positive) [W/m^2]
    'hfx',    # surface sensible heat flux (upward is positive) [W/m^2]
    'lh',    # surface latent heat flux (upward is positive) [W/m^2]
